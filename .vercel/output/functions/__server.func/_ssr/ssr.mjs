...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CER680aq.mjs");
...
var manifest = {
	"1676ad1a665b492cf7e3d00fdeb60ebc473f17761f6b1e8fa780ef3f44da23dc": {
		functionName: "getGemDetail_createServerFn_handler",
		importer: () => import("./actions-BPrw-m29.mjs")
	},
	"309b5e67be5a107c8f4874bf603f9b9f7b9288b50116e912474a0afd0367cae5": {
		functionName: "scanMarket_createServerFn_handler",
		importer: () => import("./actions-BPrw-m29.mjs")
	},
	"6337d36dafab7020921056b62bc291afd87d4d906b5d9af8ce1487927172dd00": {
		functionName: "getWatchGems_createServerFn_handler",
		importer: () => import("./actions-BPrw-m29.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C0xayQo6.mjs").then((n) => n.t),
